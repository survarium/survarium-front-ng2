let dict = {
    ...
    banned       : 'Банов',
    donate       : {
        title    : 'Поддержать монетой',
        target   : 'Поддержка survarium.pro',
        comment     : 'Вы можете указать свой игровой никнейм, либо пожелание, предложение.',
        commentLabel: 'Комментарий',
        targetLabel: 'Назначение перевода',
        amountLabel: 'Сумма',
        currency: 'руб.',
